...
from ui.screens.ship_screen import ShipScreen
...
class ShipListScreen(Screen):
    ...
    def on_mount(self) -> None:
        ...
        columns = ["Symbol", "Waypoint", "Status", "Mode", "Destination",
                   "Arrival Time", "ETA", "Cooldown", "Fuel", "Max", "Cargo", "Capacity"]
    ...
    def update_row(self, ship: Ship):
        ...
        self.ship_table.update_cell(ship.symbol, "Capacity", ship.cargo.capacity)
